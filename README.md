...
|![Screenshot](figures/flow_diagram_modules.png)|
|:--:| 
| *Figure 4. Flow Diagram - Repository Modules* |
...
|![Screenshot](figures/example_capture_data.png)|
|:--:| 
|*Figure 5 Example Captured Data*|
...
|![Screenshot](figures/log_file.png)|
|:--:| 
|*Figure 8. Patient log that tracks activity of the pacemaker capture threshold detection algorithm*|
...
* Normal lead impedance ranges from about 300-1500 ohms
* V = Voltage
* t = time
* I = V/R 
* E =(V^2*t)/R
